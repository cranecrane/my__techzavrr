        ...
        <div class="item__form">
          <form class="form" action="#" method="POST">
            ...
            <fieldset class="form__block">
              ...
              <ProductColors :list-data="product" :activeColor.sync="currentColor"/>
            </fieldset>
            ...
            <fieldset class="form__block">
              ...
              <ul class="sizes sizes--primery">
                <li class="sizes__item">
                  <label class="sizes__label" for="sizes-item1">
                    <input class="sizes__radio sr-only" type="radio" name="sizes-item1" value="32" />
                    <span class="sizes__value"> 32gb </span>
                  </label>
                </li>
                <li class="sizes__item">
                  <label class="sizes__label" for="sizes-item2">
                    <input class="sizes__radio sr-only" type="radio" name="sizes-item2" value="64" />
                    <span class="sizes__value"> 64gb </span>
                  </label>
                </li>
                <li class="sizes__item">
                  <label class="sizes__label" for="sizes-item3">
                    <input class="sizes__radio sr-only" type="radio" name="sizes-item3" value="128" checked="" />
