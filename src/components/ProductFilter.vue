    ...
    <form class="filter__form form" action="#" method="get" @submit.prevent="submit">
      <fieldset class="form__block">
        ...
        <label class="form__label form__label--price" for="min-price">
          <input class="form__input" type="number" name="min-price" min="0"
      ...
      <fieldset class="form__block">
        ...
        <ProductColors :list-data="colors" :activeColor.sync="currentColorId"/>
      </fieldset>
        ...
        <ul class="check-list">
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="volume2">
              <input class="check-list__check sr-only" type="checkbox" name="volume2" value="16">
              <span class="check-list__desc">
                16
                <span>(461)</span>
              </span>
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="volume3">
              <input class="check-list__check sr-only" type="checkbox" name="volume3" value="32">
              <span class="check-list__desc">
                32
                <span>(313)</span>
              </span>
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="volume4">
              <input class="check-list__check sr-only" type="checkbox" name="volume4" value="64">
              <span class="check-list__desc">
                64
                <span>(313)</span>
              </span>
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="volume5">
              <input class="check-list__check sr-only" type="checkbox" name="volume5" value="128">
              <span class="check-list__desc">
                128
                <span>(313)</span>
              </span>
          ...
          <li class="check-list__item">
            <label class="check-list__label" for="volume6">
              <input class="check-list__check sr-only" type="checkbox" name="volume6" value="264">
              <span class="check-list__desc">
                264
                <span>(313)</span>
              </span>
...
export default {
  ...
  computed: {
    ...
    colorsIds() {
      const colorsIds = [];
      colorsLib.forEach((color) => colorsIds.push(color.id));
      return colorsIds;
    },
    colors() {
      return {
        id: 'filter-colors',
        colors: this.colorsIds,
      };
    },
  },
  watch: {
